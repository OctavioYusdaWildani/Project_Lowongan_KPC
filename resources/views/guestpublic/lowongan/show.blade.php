        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <div class="mt-6 flex gap-4">
                    ...
                    {{-- Tombol Trigger --}}
                    @auth
                        {{-- Kalau sudah login, baru bisa buka modal --}}
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}"
                        onclick="return confirm('Kamu harus login terlebih dahulu untuk melamar. Lanjut ke halaman login?')"
                ...
                {{-- Modal Apply, hanya render kalau user login --}}
                @if(auth()->check())
